...
workflow checkerWorkflow_vcf {
  ...
  task variantCalling {
   ...
   call checker.checkerTask { input: inputCRAMFile=variantcaller.topmed_variant_caller_output_file, expectedNumofReads=expectedNumofReads, docker_image=docker_image }
