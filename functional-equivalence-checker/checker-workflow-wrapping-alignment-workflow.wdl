...
import "https://raw.githubusercontent.com/DataBiosphere/topmed-workflows/feature/checker-fix/functional-equivalence-checker/topmed-alignment-checker.wdl" as checker
...
workflow checkerWorkflow {
 ...
 Float disk_size = ref_size + size(aligner.output_cram, "GB")
